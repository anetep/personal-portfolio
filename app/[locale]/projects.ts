...
export const projects = {
  en: {
    motus: {
      ...
      visual: { description: "This case study is intentionally text-led while screenshots and Figma designs remain private." },
    ...
    "licensing-modernisation": {
      ...
      outcome: { title: "Outcome", description: "The service is integrated into MOTUS and used in production, with internal licensing details kept private." }, technologies: [".NET 8", "ASP.NET Core", "REST", "SOAP", "DTOs"],
    },
  },
  pt: {
    motus: {
      ...
      visual: { description: "Este caso de estudo mantém-se centrado no texto enquanto screenshots e designs permanecem privados." },
      ...
      outcome: { title: "Utilização real", description: "O MOTUS é utilizado por vários municípios portugueses. Participei numa reunião com cliente e dei formação sobre a plataforma." }, technologies: ["React", ".NET", "Nivo", "Figma", "Entity Framework", "Razor Pages"],
    },
    o2move: {
      slug: "o2move",
    ...
    "licensing-modernisation": {
      ...
      outcome: { title: "Resultado", description: "O serviço está integrado no MOTUS e é utilizado em produção, mantendo privados os detalhes internos." }, technologies: [".NET 8", "ASP.NET Core", "REST", "SOAP", "DTOs"],
    },
  },
} as const;
