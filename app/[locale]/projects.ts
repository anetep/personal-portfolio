...
export const projects = {
  en: {
    ...
    "immersive-cicd": {
      ...
      screenshots: [], technologies: ["Unity", "C#", "OpenXR", "XR Interaction Toolkit", "Universal Render Pipeline", "GitHub Actions REST API", "UnityWebRequest", "Local JSON"],
    },
  ...
  pt: {
    ...
    "immersive-cicd": {
      ...
      screenshots: [], technologies: ["Unity", "C#", "OpenXR", "XR Interaction Toolkit", "Universal Render Pipeline", "API REST GitHub Actions", "UnityWebRequest", "JSON local"],
    },
    "licensing-modernisation": {
