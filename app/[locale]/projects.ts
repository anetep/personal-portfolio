...
export const projects = {
  en: {
    ...
    o2move: {
      ...
      visual: {
        description:
          "The standby experience combines weather, air quality and UV information in a layout designed for a large unattended display.",
      },
      o2moveVisuals: {
        title: "From stops to a schematic network",
        description: "The map workflow moves from clustered stops and operator selection to an SVG schematic generated by an external service and presented inside O2MOVE.",
        hero: { caption: "Standby view with weather, air-quality and UV information for the public display.", alt: "O2MOVE standby screen showing weather forecast, air quality, UV radiation and navigation options" },
        stopMode: { caption: "Leaflet stop clustering keeps a large number of stops legible at wider map scales.", alt: "O2MOVE map with clustered public-transport stops and a stop search field" },
        hubMode: { caption: "Hub mode lets users select an operator and geographic area before requesting a schematic map.", alt: "O2MOVE map showing operator stops and a selected geographic area" },
        schematic: { caption: "The resulting SVG schematic is parsed and displayed with its lines, destinations and stop sequences.", alt: "O2MOVE screen displaying a generated schematic public-transport network map" },
      },
      overview: {
        title: "Overview",
        description:
  ...
  pt: {
    ...
    o2move: {
      ...
      visual: {
        description:
          "A experiência de standby reúne meteorologia, qualidade do ar e índice UV num layout pensado para um ecrã público não assistido.",
      },
      o2moveVisuals: {
        title: "Das paragens à rede esquemática",
        description: "O fluxo de mapas passa das paragens agrupadas e seleção do operador para um SVG esquemático gerado por um serviço externo e apresentado no O2MOVE.",
        hero: { caption: "Vista de standby com meteorologia, qualidade do ar e índice UV para o ecrã público.", alt: "Ecrã de standby do O2MOVE com previsão meteorológica, qualidade do ar, radiação UV e opções de navegação" },
        stopMode: { caption: "O agrupamento de paragens com Leaflet mantém um grande número de pontos legível em escalas mais amplas.", alt: "Mapa O2MOVE com paragens de transporte público agrupadas e pesquisa de paragem" },
        hubMode: { caption: "O modo hub permite selecionar um operador e uma área geográfica antes de pedir o mapa esquemático.", alt: "Mapa O2MOVE com paragens de um operador e uma área geográfica selecionada" },
        schematic: { caption: "O SVG resultante é processado e apresentado com linhas, destinos e sequências de paragens.", alt: "Ecrã O2MOVE com um mapa esquemático de uma rede de transporte público" },
      },
      overview: {
        title: "Visão geral",
        description:
